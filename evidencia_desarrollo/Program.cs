...
namespace evidencia_desarrollo
{
	class Program
	{
		...
		static void GuardarArchivo()
		{
			...
			TextWriter guardararchivo = new StreamWriter("C:/Users/daatc/Documents/.net/listaestudiantes.xml");
		...
		static void CargarXml()
		{
			...
			if (File.Exists("C:/Users/daatc/Documents/.net/listaestudiantes.xml"))
			{
				XmlSerializer codificador = new XmlSerializer(typeof(List<estudiante>));
				FileStream cargarXml = File.OpenRead("C:/Users/daatc/Documents/.net/listaestudiantes.xml");
